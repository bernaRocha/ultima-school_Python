...
from tkinter import * 
#### API em Python para criar ambientesgráficos
import random
import time
...
length = 500/level
### o tamanho da barra depende do nível de dificuldade


root = Tk()
#### uso da função Tk na variável root
