...
lista_de_nomes.append('algo')
print(lista_de_nomes) # ['Fulano', 'Beltrano', 'Ciclano', 'algo']
lista_de_nomes.clear()
print(lista_de_nomes) # []
#lista_de_nomes.copy()
# lista_de_nomes.count()
# lista_de_nomes.extend()
# lista_de_nomes.index()
# lista_de_nomes.insert()
# lista_de_nomes.pop()
# lista_de_nomes.remove()
